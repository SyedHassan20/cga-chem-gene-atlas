...
server <- function(input, output, session) {
  ...
  my_pastel_colors <- c("lightseagreen", "lightcoral", "#8E9ACF","#4DA1DE",
                        "#215EA8", "#3185CE", "#19376D",
                        "#C1D1E4", "#A7B5D9", "#767FC5",
                        "#D2B48C", "#B8A078", "#9F8C64",
                        "#79C7B1", "#90D897", "#A8E97F")
  ...
  output$networkPlot <- renderVisNetwork({
    ...
    # Show a notification while the plot is being generated
    showNotification("Generating network plot... This may take a few seconds.", type = "message", duration = NULL)
    future({
