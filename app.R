...
server <- function(input, output, session) {
  ...
  names(merged_df_all)[names(merged_df) == "X1st.trimester"] <- "1st"
  names(merged_df_all)[names(merged_df) == "X2nd.trimester"] <- "2nd"
  names(merged_df_all)[names(merged_df) == "X3rd.trimester"] <- "3rd"
  names(merged_df_all)[names(merged_df) == "Postnatal.lethality"] <- "Postnatal"
