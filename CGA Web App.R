...
server <- function(input, output, session) {
  ...
  my_pastel_colors <- c(
    "#1B3768", "#174A8F", "#1C6FBD", "#2986CC", "#4A9FD9", # Dark to light blues
    "lightcoral", "#B29375", "#A68D5A",                        # Red/Brown transition
    "#BDAAC6", "#D2C3E0", "#D5B7E0", "#B69DC1", "#9283A8",  # Light to dark purples
    "lightseagreen", "#94B8B8", "#A7C7C7", "#B7D4D4"              # Teal/gray mix
  )
  my_colors <- c("lightseagreen", "#94D8B8", "#A7E7C7", "#B7F4D4")
